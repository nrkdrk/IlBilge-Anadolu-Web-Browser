...
package main.java.com.ilbilge.ilbilgeanadolu.application;
...
import main.java.com.ilbilge.ilbilgeanadolu.browser.WebBrowserController;
...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		...
		//Prepare the Stage
		primaryStage.setTitle("İlBilge Anadolu");
